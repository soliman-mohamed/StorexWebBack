@extends('Layouts.app')
@section('title', __('add') . ' '. __('movie'))
@section('content')
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">{{ __('add') }} {{ __('movie') }}</h4>
            </div>
            <div class="card-body">
                <form class="row  align-items-center justify-content-center" method="POST" action="{{ route('movies.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-4">
                        <div class="mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            <input class="form-control @error('rate') is-invalid @enderror"
                                value="{{ old('rate') }}" name="rate" type="number" min="1" max="5"
                                placeholder="{{ __('rate') }}" >
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            <textarea class="form-control @error('description') is-invalid @enderror"
                             name="description" placeholder="{{ __('description') }}">{{ old('description') }}</textarea>
