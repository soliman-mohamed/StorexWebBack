    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">{{ __('edit') }} {{ __('user') }}</h4>
            </div>
            <div class="card-body">
                <form class="row  align-items-center justify-content-center"
                 method="POST" action="{{ route('users.update', $record->id) }}">
                    @csrf
                    @method('put')
                    <div class="col-md-4">
                        <div class="mb-4">
                            <input class="form-control @error('name') is-invalid @enderror"
                                value="{{ $record->name }}" name="name" type="text"
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            <input class="form-control @error('username') is-invalid @enderror"
                                value="{{ $record->username }}" name="username" type="text"
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            <input class="form-control @error('phone') is-invalid @enderror"
                                value="{{ $record->phone }}" name="phone" type="text"
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            <input class="form-control @error('email') is-invalid @enderror"
                                value="{{ $record->email }}" name="email" type="text"
